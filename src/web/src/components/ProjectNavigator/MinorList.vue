...
export default {
  ...
  created () {
    ...
    this.$eventHub.$on('patchPromoted', this.queryRelease)
    this.$eventHub.$on('patchDemoted', this.queryRelease)
    this.$eventHub.$on('minorPromoted', this.queryRelease)
    this.$eventHub.$on('minorDemoted', this.queryRelease)
  ...
  beforeDestroy() {
    ...
    this.$eventHub.$off('patchPromoted')
    this.$eventHub.$off('patchDemoted')
    this.$eventHub.$off('minorPromoted')
    this.$eventHub.$off('minorDemoted')
